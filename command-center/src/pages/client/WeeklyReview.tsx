    ...
    <div className="space-y-8 max-w-5xl pb-12">
      <div className="space-y-3">
        ...
        >
          ...
          <h1 className="text-4xl font-display font-light text-white tracking-tight mt-2">
            Weekly Review
          </h1>
          <div className="flex items-center gap-3 mt-2">
            <span className="text-[10px] font-mono px-3 py-1 rounded-full border border-white/10 text-slate-500 bg-white/[0.02]">
              {r.week}
            </span>
