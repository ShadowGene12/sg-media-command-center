...
function MilestoneRow({
  ...
  const cfg =
    STATUS_CONFIG[milestone.status as keyof typeof STATUS_CONFIG] ??
    ...
    >
      ...
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <span
            className={`flex-shrink-0 text-[10px] font-mono font-semibold px-2.5 py-1 rounded-full border ${cfg.bg} ${cfg.text}`}
          >
            {milestone.status}
          </span>
        </div>
          ...
          {phases.map((phase) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-2xl font-display font-light text-white mt-1">
                  {completed}
        ...
        <div className="relative" ref={lineRef}>
          ...
          <div className="absolute left-[9px] top-2 bottom-2 w-px overflow-hidden">
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, transparent, #6D4AE6 20%, #378ADD 60%, transparent)",
              }}
              initial={{ height: "0%" }}
