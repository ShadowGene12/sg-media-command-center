...
const Badge = ({
  ...
  <span
    className={`text-[9px] font-mono font-semibold px-2 py-0.5 rounded-full border ${cfg.text} ${cfg.bg} ${cfg.border}`}
  >
    {label}
  </span>
);
    ...
    <div className="space-y-10 max-w-5xl pb-12">
      ...
      <div className="space-y-4">
        {RECS.map((rec, i) => {
          ...
          const urgencyBadge =
            URGENCY_BADGE[rec.urgency] ?? URGENCY_BADGE["This Quarter"];
          const statusBadge =
            STATUS_BADGE[rec.status] ?? STATUS_BADGE["Not Started"];
            ...
            >
              <PremiumCard glowColor={`${color}0D`} className="group">
                ...
                <div className="p-6">
                  ...
                  {/* Action steps */}
                  <div
                    className="ml-13 pl-0 space-y-4"
