  ...
  return (
    <div className="space-y-8 max-w-5xl pb-12">
      ...
      >
        ...
        <span className="text-[10px] font-mono px-3 py-1 rounded-full border border-white/10 text-slate-500 bg-white/[0.02] inline-block">
          {r.month}
        </span>
      </motion.div>
      ...
      >
        {Object.entries(r.metricsReview).map(([key, val]) => (
          ...
          >
            ...
            <p className="text-[9px] font-mono uppercase tracking-widest text-slate-600 mt-1 capitalize">
        ...
        >
          <div className="space-y-2">
            {r.improved.map((item, i) => (
              ...
              >
                <div
                  className="h-1.5 w-1.5 rounded-full bg-emerald-500 mt-1.5 flex-shrink-0"
      ...
      >
        <div className="space-y-2">
          {r.progressAreas.map((p, i) => (
            ...
            >
              <span className="text-[10px] font-mono font-bold text-violet-400/60 w-4 flex-shrink-0">
                {i + 1}
              </span>
