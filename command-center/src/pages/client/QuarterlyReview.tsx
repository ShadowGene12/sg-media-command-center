  ...
  return (
    <div className="space-y-8 max-w-5xl pb-12">
      ...
      >
        <GlassCard>
          <div className="px-5 py-4 border-b border-white/[0.04]">
            <SectionLabel>Quarter Summary</SectionLabel>
          </div>
          <div className="p-5">
      ...
      >
        <GlassCard>
          <div className="px-5 py-4 border-b border-white/[0.04]">
            <SectionLabel>Progress by Pillar</SectionLabel>
          </div>
        ...
        >
          <div className="space-y-2">
            {r.lessons.map((l, i) => (
              ...
              >
                <span className="text-[10px] font-mono font-bold text-slate-600 w-4 flex-shrink-0">
                  {i + 1}
                </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <CardSection
          ...
          iconColor="#6D4AE6"
          label="Long-Term Recommendation"
        >
          <p className="text-sm text-slate-400 leading-relaxed">
            {r.longTermRecommendations}
          </p>
        </CardSection>
      </div>
    </div>
