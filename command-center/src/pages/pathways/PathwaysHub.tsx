...
const MOCK_PATHWAYS = [
  ...
  },
  {
    ...
    duration: "2 Weeks",
    description:
      "Transform a confusing service into a highly-desirable productized offer that prospects actually understand.",
    status: "available",
    progress: 0,
    locked: false,
  },
  {
    ...
    duration: "3 Weeks",
    description:
      "Audit your expenses, renegotiate vendor contracts, and improve your gross margin by 5-10%.",
    status: "locked",
    progress: 0,
    locked: true,
  },
                  ...
                  <PremiumCard glowColor={`${color}1A`}>
                    ...
                    <div className="md:flex">
                      ...
                      <div className="hidden md:flex flex-1 items-center justify-center p-8 relative">
                        <Target
                          className="w-24 h-24 absolute opacity-[0.04]"
                          style={{ color }}
                        />
