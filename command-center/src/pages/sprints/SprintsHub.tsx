    ...
    return (
      <div className="max-w-3xl mx-auto space-y-10 pb-12 pt-10 px-4 text-center">
        <PremiumCard glowColor="rgba(139, 92, 246, 0.12)" className="p-10 md:p-14 flex flex-col items-center">
          ...
          <h2 className="text-3xl font-display font-light text-white mb-4">Sprint Tracker Locked</h2>
          <p className="text-slate-400 max-w-lg mb-8 leading-relaxed font-light">
            Your free tier includes permanent access to your Bottleneck Report and dashboard. Upgrade to Operator to execute focused sprints with metric tracking and AI-driven weekly insights.
          </p>
          <Link to="/upgrade">
