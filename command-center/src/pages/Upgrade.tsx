...
const Upgrade = () => {
  // ⚡ Bolt: Using specific state selectors to avoid Upgrade page re-renders from unrelated store updates
  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-4 space-y-12 pb-16">
      ...
      <div className="text-center space-y-4">
        <p className="font-mono text-xs text-violet-400/70 uppercase tracking-widest">
        ...
        <p className="text-white/40 text-lg max-w-xl mx-auto font-light">
          The diagnosis is always free. The fix path is what you're choosing
          now.
        </p>
      </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-xs text-amber-400">
              {trialDay === 7
                ? "Trial ends tonight"
                : `${8 - trialDay} days left in your trial`}
            </span>
          </div>
          <span className="text-[10px] font-mono text-amber-400/60">
            Lifetime pricing locked in if you upgrade now
          </span>
        </motion.div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {TIERS.map((t, i) => {
          const isCurrent =
            tier === t.id ||
            (t.id === "free" && (tier === "free" || tier === "trial"));
          return (
            <motion.div
              key={t.id}
              custom={i}
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(ellipse at 50% 0%, ${t.glowColor}, transparent)`,
                  }}
                />
                ...
                <div className="relative z-10 flex flex-col flex-1">
                  ...
                  {/* Price */}
                  <div className="mb-2">
                    <span className="text-3xl font-display font-light text-white">
                      {t.price}
                    </span>
                    {t.sub && (
                  ...
                  <p className="text-xs text-white/35 font-light mb-6 leading-relaxed">
                    {t.description}
                  </p>
                  ...
                  <div className="space-y-2.5 flex-1 mb-6">
                    ...
                    {t.locked.map((f) => (
                      ...
                      >
                        ...
                        <span className="text-xs text-white/30 font-light leading-snug line-through">
                          {f}
                        </span>
                      </div>
                    ))}
                  ...
                  {t.id === "dfy" ? (
                    <a
                      href="mailto:shadow@sgmedia.in?subject=Done For You Enquiry"
                      className="block"
                    >
                      <Button
                        variant="outline"
                    ...
                    >
                      <Zap
                        ...
                        style={{ color: t.popular ? undefined : t.color }}
                      />
                      {t.cta}
                    </Button>
                  )}
      ...
      <div className="max-w-2xl mx-auto space-y-4">
        <h2 className="text-lg font-display font-light text-white text-center mb-6">
          Common questions
        </h2>
        {[
          {
