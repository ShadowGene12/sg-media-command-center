...
const ProfitCalculator = () => {
  ...
  const data = [
    ...
    {
      name: "+10% Price",
      net: grossProfit + revenue * 0.1 - opex - totalCac,
      gross: grossProfit + revenue * 0.1,
    },
    {
      name: "-10% CAC",
      net: grossProfit - opex - totalCac * 0.9,
      gross: grossProfit,
    },
    {
      name: "Combined",
      net: grossProfit + revenue * 0.1 - opex - totalCac * 0.9,
      gross: grossProfit + revenue * 0.1,
    },
  ];
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Model your margins and find hidden profit leaks.
          </p>
        </div>
      </div>
