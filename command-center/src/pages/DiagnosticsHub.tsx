...
const DIAGNOSTICS = [
  ...
  },
  {
    ...
    desc: "Deep-dive into target market and offer positioning",
    time: "~8 min",
    color: "#6D4AE6",
    lastRun: null,
    score: null,
  },
  {
    ...
    desc: "Channel mix, CAC tracking, lead consistency",
    time: "~8 min",
    color: "#378ADD",
    lastRun: null,
    score: null,
  },
  {
    ...
    desc: "Process maturity, conversion rate, follow-up cadence",
    time: "~8 min",
    color: "#1D9E75",
    lastRun: null,
    score: null,
  },
  {
    ...
    desc: "Margin analysis, pricing power, cost structure",
    time: "~8 min",
    color: "#F59E0B",
    lastRun: null,
    score: null,
  },
  {
    ...
    desc: "KPI tracking, cash flow visibility, review cadence",
    time: "~8 min",
    color: "#D85A30",
    lastRun: null,
    score: null,
  ...
  <div className="max-w-6xl mx-auto space-y-10 pb-12">
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="text-sm font-semibold text-white">
            Last diagnostic:{" "}
            <span className="text-violet-400 font-mono">14 days ago</span>
          </p>
          <p className="text-xs text-slate-500 font-mono mt-0.5">
            Overall score: 14.2 / 25.0
          </p>
        </div>
      </div>
      <div className="flex gap-2 flex-shrink-0">
        ...
        <Button
          variant="outline"
          className="rounded-full h-10 px-5 text-sm border-white/10 text-slate-400 hover:text-white"
        >
          Compare
        </Button>
      </div>
              ...
              style={
                {
                  ...
                  boxShadow: diag.accent
                    ? `0 0 30px -8px ${diag.color}20`
                    : undefined,
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: `0 0 8px ${diag.color}80`,
                }}
              />
      ...
      >
        <PremiumCard glowColor="rgba(109,74,230,0.08)">
          {HISTORY.map((entry, i) => (
            <div
              key={i}
              className="flex items-center justify-between px-6 py-4 hover:bg-white/[0.02] transition-colors border-b border-white/[0.03] last:border-0 group"
            >
              <div>
