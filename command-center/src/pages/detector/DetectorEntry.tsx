    ...
    <div className="min-h-screen bg-[#0A0A0C] text-[#F8F9FA] relative overflow-hidden flex flex-col font-sans">
      ...
      <header className="p-6 md:px-12 flex justify-between items-center relative z-10 border-b border-white/5">
        <div className="flex items-center gap-2 text-xl font-display font-bold tracking-tight">
          ...
          <span className="text-white tracking-widest text-sm uppercase mt-0.5">
            Media
          </span>
        </div>
        <Link
      ...
      <main className="flex-1 flex flex-col relative z-10 px-4 py-16 md:py-24">
        ...
        <div className="max-w-4xl mx-auto text-center mb-24">
          <h1 className="text-5xl md:text-6xl font-display font-bold tracking-tight mb-6 leading-snug">
            Find the bottleneck silently killing your growth.
          </h1>
          <p className="text-xl text-white/60 max-w-2xl mx-auto mb-16">
            An 8-minute diagnostic across the five pillars of growth
            infrastructure. Results delivered to your inbox.
          </p>
          <div className="flex flex-col items-center gap-3">
            <Link to="/detector/flow">
              <Button
                size="lg"
                onClick={() => {
                  trackEvent('cta_clicked', { label: 'Start Diagnostic Hero' });
                  trackEvent('detector_started');
                }}
                className="h-14 px-8 text-lg font-medium shadow-[0_0_20px_-5px_rgba(109,74,230,0.5)] hover:shadow-[0_0_30px_-5px_rgba(109,74,230,0.6)] transition-all"
              >
                Start the diagnostic →
              </Button>
            </Link>
            <span className="text-xs text-white/60 uppercase tracking-widest font-mono mt-2 opacity-70">
        ...
        <div className="max-w-5xl mx-auto w-full mb-32">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 p-6 rounded-xl hover:border-primary/50 transition-all hover:-translate-y-1 hover:shadow-lg">
              ...
              <p className="text-sm text-white/70 leading-relaxed">
                Identified with a 0-5 score across all five growth
                infrastructure pillars. See exactly where you're bleeding
                revenue.
              </p>
            </div>
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 p-6 rounded-xl hover:border-primary/50 transition-all hover:-translate-y-1 hover:shadow-lg">
              ...
              <p className="text-sm text-white/70 leading-relaxed">
                We don't just point out the surface symptom. We map it down to
                the system failure and the root foundation issue.
              </p>
            </div>
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 p-6 rounded-xl hover:border-primary/50 transition-all hover:-translate-y-1 hover:shadow-lg">
              <div className="h-12 w-12 rounded-lg bg-primary/10 flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-white/70 leading-relaxed">
                Walk away with the single highest-leverage fix for your current
                stage. No fluff, just the next right step.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto w-full text-center">
          <p className="text-sm font-mono text-white/60 uppercase tracking-widest mb-8">
      ...
      <footer className="border-t border-white/5 bg-black/50 backdrop-blur-md py-8 relative z-10 text-center">
        <Link to="/detector/flow">
          <Button
            size="lg"
            onClick={() => {
              trackEvent('cta_clicked', { label: 'Start Diagnostic Footer' });
              trackEvent('detector_started');
            }}
            className="mb-3 shadow-lg hover:shadow-primary/20 transition-all"
          >
            Start the diagnostic →
          </Button>
        </Link>
