...
const LOCKED_TOOLS = [
  {
    ...
    icon: BarChart3,
    desc: "Model margins and find hidden profit leaks",
  },
  {
    name: "Offer Clarity Audit",
    icon: Target,
    desc: "Score your offer against 12 clarity markers",
  },
  {
    name: "Funnel Mapper",
    icon: Wrench,
    desc: "Visualize your acquisition funnel end-to-end",
  },
  {
    name: "Pillar Deep-Dives",
    icon: BookOpen,
    desc: "Structured learning for every growth pillar",
  },
  {
    name: "Action Plan System",
    icon: CheckSquare,
    desc: "Track and execute your highest-leverage fixes",
  },
];
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
        <div>
          ...
          <p className="text-sm font-mono text-muted-foreground mt-2">
            Completed on {MOCK_DIAGNOSTIC.date} · View ID:{" "}
            {MOCK_DIAGNOSTIC.viewId}
          </p>
        </div>
        <div className="flex gap-2">
          <Button
            ...
            variant="outline"
            size="sm"
            className="bg-white/5 border-white/10 backdrop-blur-md hover:bg-white/10"
          >
            {isGenerating ? (
      ...
      <div id="pdf-content" className="space-y-8">
        ...
        <div
          className="bg-card border border-border rounded-xl p-6 md:p-8 border-l-4 shadow-lg"
          style={{ borderLeftColor: primaryPillar.color }}
        >
        ...
        <div className="bg-gradient-to-br from-violet-900/20 to-black/20 border border-violet-500/25 rounded-2xl p-8 relative overflow-hidden shadow-[0_0_30px_rgba(79,70,229,0.15)]">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl font-bold text-white mb-3">
              Fix Your Sales Conversion Engine
            </h2>
            <p className="text-violet-200 max-w-2xl mb-8 leading-relaxed">
              Based on your primary bottleneck, we recommend starting this
              4-week guided pathway. It will take you step-by-step through
              documenting your sales process, handling objections, and building
              a follow-up cadence.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link to="/pathways/sales-engine">
                <Button
                  size="lg"
                  className="bg-violet-600 hover:bg-violet-500 text-white px-8 h-12 shadow-[0_0_15px_rgba(79,70,229,0.4)]"
                >
                  Start Pathway
                </Button>
              </Link>
              <Link to="/sprints/new?bottleneck=sales">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-violet-500/25 hover:bg-violet-500/10 text-white h-12"
                >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                {
                  title: "The Perfect Sales Script Template",
                  time: "15 min read",
                  type: "Template",
                },
                {
                ...
                <Link key={i} to="/library/sample-sop" className="group block">
                  <div className="bg-black/40 backdrop-blur-xl border border-white/5 rounded-xl p-5 hover:border-primary/40 transition-colors h-full flex flex-col justify-between">
                    <div>
                      <span className="text-xs font-medium text-slate-400 bg-slate-800 px-2 py-1 rounded-md mb-3 inline-block">
                        {sop.type}
                      </span>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-black/40 backdrop-blur-xl border border-white/5 rounded-xl p-6 h-full flex flex-col items-center justify-center text-center">
              ...
              <p className="text-sm text-slate-400 mb-6">
                Ask the AI Advisor specific questions about your diagnostic
                results.
              </p>
