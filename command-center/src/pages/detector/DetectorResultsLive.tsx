  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 -20px 80px rgba(109,74,230,0.12), 0 40px 100px rgba(0,0,0,0.8)",
      }}
    >
      {/* Browser chrome */}
      ...
      <div className="flex" style={{ height: "clamp(680px, 80vh, 900px)" }}>
        ...
        <div className="w-16 border-r border-white/[0.04] bg-black/60 flex flex-col flex-shrink-0">
          <div className="h-16 flex items-center justify-center border-b border-white/[0.03]">
            <div
              className="w-9 h-9 rounded-xl bg-violet-500/10 border border-violet-500/20 flex items-center justify-center"
          ...
          <div className="flex-1 py-4 flex flex-col gap-1.5 items-center px-2.5">
            ...
            <div className="mt-auto">
              {[Lock, Lock].map((Icon, i) => (
                <div
                  key={i}
                  className="w-full h-9 rounded-xl flex items-center justify-center opacity-30 mt-1"
                >
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <div className="px-2.5 py-1 bg-violet-500/10 border border-violet-500/20 rounded-full flex items-center gap-1.5">
                ...
                <span className="text-[9px] text-violet-400 font-mono">
                  Day 1 of 7 — Trial Active
                </span>
              </div>
              <div className="w-8 h-8 rounded-full bg-violet-500/20 border border-violet-500/30 flex items-center justify-center text-[10px] font-mono text-violet-400 font-bold">
                S
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-hidden p-5 md:p-6">
            ...
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <h2 className="text-lg font-display font-light text-white tracking-tight">
                  Bottleneck Report
                </h2>
                <p className="text-xs text-slate-500 mt-0.5">
                  Your 5-pillar diagnostic — scores, root causes, and priority
                  actions.
                </p>
              </div>
              ...
              <div className="lg:col-span-4 space-y-4">
                    ...
                    <div className="relative w-20 h-20 flex-shrink-0">
                      ...
                      >
                        ...
                        <motion.circle
                          ...
                          animate={{
                            strokeDasharray: `${(13.8 / 25) * 201} 201`,
                          }}
                          transition={{
                            duration: 1.4,
                            delay: 0.6,
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-violet-400 animate-pulse" />
                    <span className="text-[9px] text-violet-400 uppercase tracking-widest font-mono">
                      Primary Bottleneck
                    </span>
                  </div>
                  ...
                  <div className="font-mono text-2xl font-light text-violet-400 mb-2">
                    1.8 <span className="text-sm text-white/25">/ 5.0</span>
                  </div>
                  <div className="text-[10px] text-white/30 mb-3 leading-relaxed">
                    You have a follow-up gap, not a lead gap. 80% of your
                    qualified leads go cold between Day 1 and Day 14.
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-[9px] text-violet-400 font-mono uppercase tracking-widest">
                      AI Advisor
                    </span>
                    ...
                    <div className="flex">
                      <div className="bg-white/[0.04] border border-white/[0.07] rounded-xl rounded-tl-sm px-2.5 py-1.5 max-w-[90%]">
                        <p className="text-[9px] text-white/55 leading-relaxed">
                          Your score reflects a follow-up gap — 4 leads dormant
                          7+ days. Start by building a 5-touch sequence.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-2.5 flex-1">
                  {PILLARS.map((p, idx) => (
                    <motion.div
                      ...
                      style={{
                        background: p.critical
                          ? "rgba(109,74,230,0.06)"
                          : "rgba(0,0,0,0.4)",
                        borderTop: p.critical
                          ? "1px solid rgba(109,74,230,0.2)"
                    ...
                    >
                      ...
                      />
                      <span className="text-sm text-slate-300 flex-1 truncate font-light">
                        {p.name}
                      </span>
                      ...
                      <div className="flex items-center gap-1.5 flex-shrink-0">
                        <span
                          ...
                          style={{ color: p.up ? "#10B981" : "#EF4444" }}
                        >
                          {p.up ? (
                      ...
                      <span
                        className="font-mono text-lg font-light flex-shrink-0"
                        style={{ color: p.color }}
                      >
                        {p.score.toFixed(1)}
                      </span>
                ...
                <div className="grid grid-cols-3 gap-3 mt-4">
                  {[
                    ...
                    >
                      ...
                      <div>
                        <div className="font-mono text-base font-light text-white">
                          {stat.value}
                        </div>
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      await exportDiagnosticPDF({
        firstName:
          localStorage.getItem("sg_user_email")?.split("@")[0] ?? "Operator",
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-light tracking-tight mb-8 leading-[1.05]">
              ...
              <em className="not-italic text-violet-400">live</em> in Command
              Center.
            </h1>

            {/* Subtext */}
            <p className="mx-auto max-w-xl text-lg text-white/40 leading-relaxed mb-10 font-light">
              Your primary bottleneck has been identified. Your full 5-pillar
              diagnostic, SOPs, and AI Advisor are ready — mapped to your
              specific results.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <div className="bg-white/[0.05] rounded-[14px] border border-white/[0.08] p-0.5">
                ...
                >
                  {user
                    ? "View my report in Command Center"
                    : "Create account — Enter Command Center"}
