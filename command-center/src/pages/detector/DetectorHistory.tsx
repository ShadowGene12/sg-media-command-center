...
const TREND_POINTS = MOCK_HISTORY.slice()
  .reverse()
  .map((r) => r.score);
const maxScore = 25;
const chartH = 80;
    ...
    <div className="max-w-5xl mx-auto space-y-10 pb-20 pt-2 px-4 sm:px-6">
      ...
      >
        ...
        <motion.div variants={itemVars} className="md:col-span-8">
          <PremiumCard
            glowColor="rgba(109, 74, 230, 0.12)"
          ...
          >
            ...
            <div className="flex items-end gap-6 mb-4 mt-2">
              <div>
                ...
                <span className="text-sm font-mono text-slate-600 ml-1">
                  / 25.0
                </span>
              </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-slate-500 leading-relaxed text-center">
                Select two past runs to generate a side-by-side scorecard and
      ...
      <div>
        <p className="text-sm font-mono text-slate-400 uppercase tracking-widest mb-5">
          Past Runs — {MOCK_HISTORY.length} entries
        </p>
        <motion.div
          variants={containerVars}
          initial="hidden"
          ...
          {MOCK_HISTORY.map((run, i) => {
            ...
            return (
              <motion.div key={run.id} variants={itemVars}>
                <PremiumCard
                  glowColor={PILLAR_GLOW[color] ?? "rgba(139,92,246,0.10)"}
                  className="group"
                >
                  <div className="flex flex-col sm:flex-row items-center gap-6 p-7">
                    ...
                    <div className="relative h-16 w-16 flex-shrink-0">
                      ...
                      >
                        ...
                        <motion.circle
                          ...
                          animate={{
                            strokeDashoffset:
                              2 * Math.PI * 26 * (1 - run.score / maxScore),
                          }}
                          transition={{
                            duration: 1.2,
                            ease: "easeOut",
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-sm font-display font-light text-white">
                          {run.score}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1.5 flex-wrap">
                        <p className="text-base font-display font-light text-white">
                          {run.date}
                        </p>
                        {run.improvement && (
