    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
      <Card className="bg-slate-900 border-white/10">
        <CardHeader>
          ...
          <CardDescription>
            Manage your team workspace and basic branding.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div>
            ...
            <div className="flex gap-4">
              <Input
                defaultValue="SG Media Internal"
                className="max-w-md h-12 bg-slate-800 border-white/10"
              />
              <Button className="h-12 bg-white/10 hover:bg-white/20 text-white">
                Save
              </Button>
            </div>
          </div>
      ...
      <Card className="bg-slate-900 border-white/10">
        <CardHeader className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Invite colleagues to collaborate on sprints and pathways. (3/5
              seats used)
            </CardDescription>
          </div>
        ...
        <CardContent>
          <div className="space-y-2">
            {TEAM_MEMBERS.map((member) => (
              <div
                key={member.id}
                className="flex flex-col md:flex-row md:items-center justify-between p-4 rounded-xl border border-white/5 bg-slate-800/50 hover:bg-white/5 transition-colors gap-4"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-white flex items-center gap-2">
                      {member.name}
                      {!member.active && (
                        <span className="text-xs font-normal text-amber-400 bg-amber-400/10 px-2 py-0.5 rounded">
                          Pending
                        </span>
                      )}
                    </div>
