    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-6 rounded-xl bg-slate-800/50 border border-white/5">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="px-2 py-1 text-xs font-semibold bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 rounded">
                  Active
                </span>
              </div>
              <p className="text-slate-400">
                ₹4,900 / month. Next billing date: Nov 15, 2026
              </p>
            </div>
      ...
      <div className="pt-8 border-t border-red-500/20">
        ...
        <p className="text-sm text-slate-400 mb-4">
          Canceling your subscription will lock your account at the end of your
          billing cycle. You will lose access to premium SOPs, sprint tracking,
          and AI Advisor.
        </p>
        <Button
          variant="outline"
