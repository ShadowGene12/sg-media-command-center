...
const PillarsHub = () => {
  ...
  const scores: Record<string, number> =
    diagnostic?.pillar_scores ?? FALLBACK_SCORES;
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 pb-12">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        >
          <PremiumCard
            glowColor="rgba(109,74,230,0.10)"
            className="p-6 w-full flex items-center justify-center min-h-[350px]"
          >
            ...
            >
              <PremiumCard
                ...
                style={
                  pillar.isPrimary
                    ? ({
                        borderColor: "rgba(109,74,230,0.2)",
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <span className="text-sm text-slate-300 font-light truncate block">
                    {pillar.name}
                  </span>
                  {pillar.isPrimary && (
      ...
      {diagnostic && (
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              {
                label: "Surface Symptom",
                color: "#EF4444",
                content:
                  "Low close rates and inconsistent deal flow. Prospects enter the pipeline but stall or disappear without a clear handoff.",
              },
              {
