...
const CommandCenterMockup = () => (
  <div
    ...
    style={{
      boxShadow: "0 0 80px rgba(109,74,230,0.15), 0 40px 100px rgba(0,0,0,0.8)",
    }}
  >
    {/* Browser chrome */}
    <div className="flex items-center gap-2 px-4 py-2.5 border-b border-white/[0.04] bg-[#050505]">
      ...
      <div className="ml-3 flex-1 h-4 bg-white/[0.03] rounded-md flex items-center px-2 gap-1.5">
        ...
        <span className="text-[9px] text-white/15 font-mono">
          app.sgmedia.com/command-center
        </span>
      </div>
    </div>
    ...
    <div className="flex" style={{ height: "460px" }}>
      ...
      <div className="w-14 border-r border-white/[0.04] bg-black/60 flex flex-col flex-shrink-0">
        ...
        <div className="h-[54px] flex items-center justify-center border-b border-white/[0.03] flex-shrink-0">
          <div
            className="w-8 h-8 rounded-xl bg-violet-500/10 border border-violet-500/20 flex items-center justify-center"
        ...
        <div className="flex-1 py-4 flex flex-col gap-1 items-center px-2 overflow-hidden">
          ...
          {[Compass, BookOpen, FileText, Flag, Wrench, Sparkles].map(
            (Icon, i) => (
              <div
                key={i}
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-[#0A0A0C]">
        ...
        <div className="flex-1 overflow-hidden px-5 py-4 space-y-4">
          ...
          <div className="grid grid-cols-12 gap-3">
            ...
            >
              <div className="text-[7px] font-mono text-slate-500 uppercase tracking-widest mb-2">
                System Score
              </div>
              ...
              <div className="w-full flex items-end gap-0.5 h-4 mt-2 opacity-30 px-2">
                {[4, 5, 3, 6, 7, 5, 8, 9].map((h, i) => (
                  <div
                    key={i}
                    className="flex-1 bg-cyan-400/50 rounded-t-sm"
                    style={{ height: `${h * 10}%` }}
                  />
                ))}
              </div>
            ...
            >
              <div className="text-[7px] font-mono text-slate-500 uppercase tracking-widest mb-3">
                Required Actions
              </div>
              <div className="space-y-2">
                {[
                  {
                    ...
                    label: "Review generated copy for LinkedIn sequence",
                    width: "75%",
                  },
                  {
                    done: false,
                    label: "Approve budget allocation for Q3 Ads",
                    width: "60%",
                  },
                  {
                    done: true,
                    label: "Log weekly KPI check-in",
                    width: "48%",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className={`flex items-center gap-2.5 py-1 ${item.done ? "opacity-40" : ""}`}
                  >
                    <div
                      className={`w-4 h-4 rounded-full border flex-shrink-0 flex items-center justify-center ${item.done ? "border-emerald-500/50 bg-emerald-500/10" : "border-slate-700"}`}
                    >
                      {item.done && (
...
const LandingPage = () => {
  ...
  return (
    <div
      className="min-h-screen text-[#F8F9FA] overflow-x-hidden"
            ...
            <div className="relative flex flex-wrap items-center justify-between gap-4 py-3 lg:gap-0">
              ...
              >
                    ...
                    {navItems.map((item) => (
                      <li key={item.name}>
                        {item.href.startsWith("#") ? (
                          <button
                            onClick={() => scrollTo(item.href.slice(1))}
                            className="text-white/70 hover:text-white py-1 text-left"
                          >
                            {item.name}
                          </button>
                        ) : (
                          <Link
                            to={item.href}
                            className="text-white/70 hover:text-white block py-1"
                ...
                <Link to="/detector/flow">
                  <Button
                    size="sm"
                    className="bg-violet-600 hover:bg-violet-500 text-white shadow-[0_0_15px_rgba(109,74,230,0.4)]"
                  >
      ...
      <main>
        ...
        <section className="relative pt-36 pb-4 overflow-hidden">
            ...
            >
              <div className="inline-flex items-center gap-3 rounded-full border border-white/[0.08] bg-white/[0.04] px-4 py-1.5 mb-8 backdrop-blur-sm">
                <span className="font-mono text-xs text-violet-400 uppercase tracking-widest">
                  Bottleneck Detector → Command Center
                </span>
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-light tracking-tight mb-8 max-w-4xl mx-auto leading-[1.05]">
                ...
                <em className="not-italic text-violet-400 font-light">
                  Diagnose it.
                </em>
              </h1>

              <p className="text-xl text-white/60 max-w-2xl mx-auto mb-10 leading-relaxed font-light">
                15 questions. 4 minutes. You land directly inside Command Center
                — your full growth diagnostic mapped across 5 pillars, live
                instantly.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-5">
                <div className="bg-white/[0.05] rounded-[14px] border border-white/[0.08] p-0.5">
                  <Link to="/detector/flow">
                    <Button
                      size="lg"
                      className="h-12 px-7 rounded-xl bg-violet-600 hover:bg-violet-500 text-white text-base font-medium shadow-[0_0_25px_rgba(109,74,230,0.4)] hover:shadow-[0_0_35px_rgba(109,74,230,0.5)] transition-all"
                    >
                ...
                <button onClick={() => scrollTo("how-it-works")}>
                  <Button
                    size="lg"
                    variant="ghost"
                    className="h-12 rounded-xl text-white/60 hover:text-white hover:bg-white/5 text-base"
                  >
                    See how it works
                  </Button>
                </button>
          ...
          <motion.div
            ...
            className="mx-auto max-w-7xl mt-20 -mb-24 lg:-mb-64 [mask-image:linear-gradient(to_bottom,black_40%,transparent_100%)]"
          >
        ...
        <section className="py-24 px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            >
              <p className="font-mono text-xs text-violet-400/70 uppercase tracking-widest mb-4">
                The Problem
              </p>
              ...
              <p className="text-white/60 mt-4 max-w-xl mx-auto text-lg font-light">
                Not because they're wrong about what hurts — but because the
                surface symptom isn't the actual constraint.
              </p>
            </motion.div>
            <motion.div
              ...
              {[
                {
                  icon: Target,
                  color: "#6D4AE6",
                  title: "You're solving symptoms, not systems",
                  desc: "Most operators fix what hurts loudest. The real bottleneck is usually a layer deeper — and fixing symptoms without it wastes budget and energy.",
                },
                {
                  icon: Zap,
                  color: "#378ADD",
                  title: "Generalist advice doesn't fit your context",
                  desc: "Growth tactics only work inside specific pillar contexts. The right tactic in the wrong pillar doesn't just fail — it can make things worse.",
                },
                {
                  icon: Brain,
                  color: "#1D9E75",
                  title: "You need a diagnostic before a strategy",
                  desc: "Strategy is premature without knowing your actual constraint. The Detector finds the bottleneck first. Then Command Center maps the fix path.",
                },
              ].map((item) => (
                <motion.div
                  key={item.title}
                ...
                >
                  <div
                    className="h-10 w-10 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300"
                  ...
                  <h3 className="text-lg font-display font-semibold text-white/85 mb-2">
                    {item.title}
                  </h3>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-semibold tracking-tight text-white/90">
                Five pillars. One diagnostic.
              </h2>
              <p className="text-white/60 mt-4 max-w-xl mx-auto text-lg font-light">
                The Detector measures your business across five root-level
                growth pillars. Each has its own constraint — it finds which one
            ...
            >
              {[
                ...
                <motion.div
                  key={pillar.name}
                  variants={cardItem}
                  className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5 hover:border-white/[0.12] hover:bg-white/[0.03] transition-all duration-300 flex flex-col group"
                >
                  ...
                  <h3 className="text-sm font-display font-semibold text-white/80 mb-3 leading-snug">
                    {pillar.name}
                  </h3>
                ...
                {[
                  {
                    step: "01",
                    color: "#6D4AE6",
                    title: "Take the Detector",
                    desc: "15 questions across 5 pillars. Designed for operators — no fluff, no theory. 4 minutes, calibrated answers.",
                  },
                  {
                    step: "02",
                    color: "#378ADD",
                    title: "Get Command Center access",
                    desc: "You land directly inside your dashboard — no separate results page. Your diagnosis is already rendered live.",
                  },
                  {
                    step: "03",
                    color: "#1D9E75",
                    title: "Explore your diagnostic",
                    desc: "Full access to your report, all SOPs, AI Advisor, and every Command Center feature. 7 days free. No card.",
                  },
                ].map((s) => (
                  <motion.div
                    key={s.step}
        ...
        >
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-semibold tracking-tight text-white/90">
                This is software, not a PDF.
              </h2>
              <p className="text-white/60 mt-4 max-w-xl mx-auto text-lg font-light">
                Command Center is a live diagnostic platform. Your report
                renders as a dashboard, not a document.
              </p>
            </motion.div>
            ...
            >
              ...
              <motion.div variants={cardItem} className="md:col-span-2">
                ...
                >
                  <div className="flex items-center gap-2 mb-5">
                    ...
                    <span className="font-mono text-[10px] text-violet-400 uppercase tracking-widest">
                      Bottleneck Report
                    </span>
                    <span className="ml-auto px-2 py-0.5 bg-violet-500/10 border border-violet-500/20 rounded text-[9px] text-violet-400 font-mono">
                      Live
                    </span>
                  </div>
                  <h3 className="text-lg font-display font-semibold text-white mb-1">
                    Your 5-pillar diagnostic — rendered as a dashboard.
                  </h3>
                  <p className="text-sm text-white/60 font-light mb-6">
                    Click any pillar for a 3-layer deep dive: surface symptom →
                    system failure → root cause.
                  </p>
                  <div className="space-y-3">
                    {[
                      {
                        label: "Market & Offer Clarity",
                        score: "2.1",
                        color: "#6D4AE6",
                        pct: 42,
                        tag: "Needs Work",
                      ...
                      <div key={p.label}>
                        <div className="flex items-center justify-between mb-1.5">
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="text-xs text-white/55 font-sans">
                              {p.label}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center py-4">
                    <div className="relative w-28 h-28">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        <span className="text-3xl font-display font-light text-white tracking-tighter">
                          13.8
                        </span>
                    ...
                    <div className="mt-4 flex items-end gap-0.5 h-8 w-full px-4 opacity-30">
                      {[4, 5, 3, 6, 7, 5, 8, 9].map((h, i) => (
                        <div
                          key={i}
                          className="flex-1 bg-cyan-400/60 rounded-t-sm"
                          style={{ height: `${h * 10}%` }}
                        />
                      ))}
                    </div>
              ...
              <motion.div variants={cardItem}>
                <BentoCard
                  glowColor="rgba(55,138,221,0.14)"
                  className="p-6 h-full flex flex-col"
                >
                  <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-sm font-display font-semibold text-white/85 mb-1">
                    Knows your diagnosis.
                  </h3>
                  <p className="text-xs text-white/35 font-light mb-4 leading-relaxed">
                    Ask specific questions about your actual bottleneck — not
                    generic advice.
                  </p>
                  {/* Chat preview */}
                  <div className="flex-1 space-y-2.5 mt-auto">
                    <div className="flex justify-end">
                      <div className="bg-violet-600/20 border border-violet-500/20 rounded-xl rounded-tr-sm px-3 py-2 max-w-[85%]">
                        <p className="text-[10px] text-violet-200 font-sans">
                          Why is my Sales score so low?
                        </p>
                      </div>
                    </div>
                    <div className="flex">
                      <div className="bg-white/[0.04] border border-white/[0.07] rounded-xl rounded-tl-sm px-3 py-2 max-w-[90%]">
                        <p className="text-[10px] text-white/55 font-sans leading-relaxed">
                          Your score reflects a follow-up gap — 4 leads have
                          been dormant for 7+ days. Start there.
                        </p>
                      </div>
                    </div>
              ...
              <motion.div variants={cardItem}>
                <BentoCard
                  glowColor="rgba(29,158,117,0.12)"
                  className="p-6 h-full flex flex-col"
                >
                  <div className="flex items-center gap-2 mb-4">
                  ...
                  <div className="flex items-baseline gap-1 mb-1">
                    ...
                    <span className="text-slate-300 font-medium font-mono text-sm">
                      + SOPs
                    </span>
                  </div>
                  <p className="text-xs text-white/35 font-light mb-5">
                    Mapped to your pillar scores. Every SOP knows your
                    bottleneck.
                  </p>
                    ...
                    {[
                      ...
                      <div key={p.label} className="flex items-center gap-2">
                        <div
                          ...
                          style={{ backgroundColor: p.color }}
                        />
                        <span className="text-[10px] text-white/35 font-sans flex-1">
                          {p.label}
                        </span>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="h-1.5 bg-white/[0.05] rounded-full overflow-hidden">
                      <motion.div
                        ...
                        style={{
                          background:
                            "linear-gradient(90deg, #F59E0B, #D85A30)",
                        }}
                        initial={{ width: 0 }}
        ...
        <section className="py-16 px-6 border-t border-white/[0.05]">
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <h3 className="text-2xl md:text-3xl font-display font-semibold text-white/90 mb-4">
                Your free tier keeps your report. Forever.
              </h3>
              <p className="text-white/60 max-w-xl mx-auto leading-relaxed mb-8 font-light">
                After the 7-day trial, your Bottleneck Report and dashboard stay
                fully accessible — no lock, no paywall, no expiry. The fix path
                is what's behind the paid tier. The diagnosis is always yours.
              </p>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-white/60 text-lg mb-10 font-light">
                15 questions. Dropped directly into Command Center. Free
                forever.
              </p>
              <div className="bg-white/[0.05] rounded-[14px] border border-white/[0.08] p-0.5 inline-block">
                <Link to="/detector/flow">
                  <Button
                    size="lg"
                    className="h-14 px-10 rounded-xl bg-violet-600 hover:bg-violet-500 text-white text-lg font-medium font-sans shadow-[0_0_30px_rgba(109,74,230,0.4)] hover:shadow-[0_0_40px_rgba(109,74,230,0.5)] transition-all"
                  >
                    Get my Command Center access
