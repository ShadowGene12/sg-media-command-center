...
const TOOL_GROUPS = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        icon: Search,
        desc: "Map your positioning vs competitors",
        lastRun: null,
        route: null,
      },
      {
        name: "ICP Builder",
        icon: FileText,
        desc: "Build your ideal customer profile step-by-step",
        lastRun: null,
        route: null,
      },
    ],
  },
  {
    ...
    tools: [
      ...
      {
        name: "Channel Cost Calculator",
        icon: Calculator,
        desc: "Calculate true cost per channel",
        lastRun: "1 week ago",
        route: null,
      },
    ],
    ...
    tools: [
      {
        ...
        icon: Wrench,
        desc: "Audit your sales process maturity",
        lastRun: null,
        route: null,
      },
      {
        ...
        icon: Target,
        desc: "Document and script objection responses",
        lastRun: null,
        route: null,
      },
    ],
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        icon: BarChart3,
        desc: "Evaluate pricing power and elasticity",
        lastRun: null,
        route: null,
      },
    ],
    ...
    tools: [
      {
        ...
        icon: BarChart3,
        desc: "Set up your core KPI dashboard",
        lastRun: null,
        route: null,
      },
      {
        name: "Cash Flow Scanner",
        icon: TrendingUp,
        desc: "Analyze 90-day cash flow projections",
        lastRun: null,
        route: null,
      },
    ],
...
const ToolsLibrary = () => {
  ...
  const recentTools = TOOL_GROUPS.flatMap((g) =>
    g.tools
      .filter((t) => t.lastRun)
      .map((t) => ({ ...t, pillar: g.pillar, color: g.color })),
  );
            ...
            {recentTools.map((tool, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className="h-9 w-9 rounded-xl flex items-center justify-center flex-shrink-0 border"
                    style={{
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background: `radial-gradient(circle at 0% 0%, ${group.color}08, transparent 70%)`,
                      }}
                    />

                    <div
                      className="relative z-10 h-10 w-10 rounded-xl flex items-center justify-center border"
                      style={{
                    ...
                    <div className="relative z-10 flex-1">
                      <p className="text-sm font-semibold text-white group-hover:text-violet-100 transition-colors leading-snug">
                        {tool.name}
                      </p>
