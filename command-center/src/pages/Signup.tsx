    ...
    <div className="min-h-screen text-[#F8F9FA] flex flex-col relative overflow-hidden">
      ...
      <header className="relative z-10 px-6 py-4 flex items-center justify-between border-b border-white/[0.04]">
        ...
        <span className="text-sm text-white/30">
          ...
          <Link
            to="/login"
            className="text-violet-400 hover:text-violet-300 transition-colors ml-1 font-medium"
          >
            Log in
          </Link>
        </span>
          ...
          >
            <div>
              ...
              <p className="text-white/40 text-lg leading-relaxed font-light">
                Take the Bottleneck Detector and land directly inside Command
                Center with your full diagnostic live.
              </p>
            </div>
                ...
                <div className="pt-1">
                  ...
                  >
                    {loading ? (
                      ...
                      "Create account → Take the Detector"
                    )}
                  </Button>
                </div>
