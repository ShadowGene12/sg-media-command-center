...
const DAILY_INSIGHTS: Record<number, DailyInsight> = {
  1: {
    day: 1,
    content:
      "80% of Sales bottleneck operators have a follow-up gap, not a lead gap. Your system is likely leaking at the follow-up stage — not at the top of the funnel.",
  ...
  2: {
    day: 2,
    content:
      "A documented sales process reduces close-rate variance by ~40%. If your process lives in someone's head, you have a single point of failure that scales badly.",
  ...
  3: {
    day: 3,
    content:
      "Your full bottleneck chain is now mapped. Most operators find their real constraint isn't the obvious bottleneck — it's one layer deeper in the system.",
  ...
  4: {
    day: 4,
    content:
      "Acquisition and Sales bottlenecks are causally linked. Fixing acquisition spend while Sales is broken just fills a leaking bucket faster — and costs more.",
  ...
  5: {
    day: 5,
    content:
      "48 hours left on your trial. The features that drive the most value tend to be the ones operators open once and don't return to — check what you've left unread.",
  ...
  6: {
    day: 6,
    content:
      "Your 30-Day Operator Roadmap is now live. This is the fix path — not just the diagnosis. Operator tier users execute against this roadmap every sprint cycle.",
  ...
  7: {
    day: 7,
    content:
      "Trial ends tonight. Your Bottleneck Report and dashboard stay accessible forever on the free tier. The fix path — SOPs, Roadmap, AI Advisor — locks at midnight.",
...
const INITIAL_ACTIONS: ActionItem[] = [
  {
    id: "1",
    title: "Document your sales process step-by-step",
    pillar: "Sales",
    color: "#1D9E75",
    status: "in_progress",
    due: "Apr 25",
  ...
  {
    id: "2",
    title: "Map current acquisition channels and costs",
    pillar: "Acquisition",
    color: "#378ADD",
    status: "not_started",
    due: "Apr 28",
  ...
  {
    id: "3",
    title: "Run the Offer Clarity Audit tool",
    pillar: "Market & Offer",
    color: "#6D4AE6",
    status: "not_started",
    due: "Apr 30",
  ...
  {
    id: "4",
    title: "Set up weekly KPI dashboard review cadence",
    pillar: "Financial",
    color: "#D85A30",
    status: "blocked",
    due: "May 1",
  ...
  {
    id: "5",
    title: "Review profit margins on top 3 services",
    pillar: "Profit",
    color: "#F59E0B",
    status: "completed",
    due: "Apr 18",
...
const initialTier: UserTier =
  initialTrialDay >= 1 && initialTrialDay <= 7
    ? "trial"
    : initialTrialDay > 7
      ? "free"
      : "free";
...
export const useCommandStore = create<CommandStore>((set) => ({
  ...
  syncTrialFromDB: ({ trial_started_at, tier }) =>
    set(() => {
