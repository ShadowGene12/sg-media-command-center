...
const DetectorEntry = React.lazy(
  () => import("./pages/detector/DetectorEntry"),
);

const DetectorFlow = React.lazy(() => import("./pages/detector/DetectorFlow"));
const DetectorAnalyzing = React.lazy(
  () => import("./pages/detector/DetectorAnalyzing"),
);
const DetectorResultsLive = React.lazy(
  () => import("./pages/detector/DetectorResultsLive"),
);
const DetectorResults = React.lazy(
  () => import("./pages/detector/DetectorResults"),
);
const DetectorHistory = React.lazy(
  () => import("./pages/detector/DetectorHistory"),
);
...
const LibrarySOPDetail = React.lazy(
  () => import("./pages/library/LibrarySOPDetail"),
);
...
const WorkspaceCanvas = React.lazy(
  () => import("./pages/workspace/WorkspaceCanvas"),
);
...
const ProfitCalculator = React.lazy(
  () => import("./pages/tools/ProfitCalculator"),
);
...
const BillingSettings = React.lazy(
  () => import("./pages/settings/BillingSettings"),
);
...
const ClientWeeklyReview = React.lazy(
  () => import("./pages/client/WeeklyReview"),
);
const ClientMonthlyReview = React.lazy(
  () => import("./pages/client/MonthlyReview"),
);
const ClientQuarterlyReview = React.lazy(
  () => import("./pages/client/QuarterlyReview"),
);
const ClientRecommendations = React.lazy(
  () => import("./pages/client/Recommendations"),
);
  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/detector/flow" element={<ErrorBoundary><DetectorFlow /></ErrorBoundary>} />
