  ...
  return (
    ...
    >
      <Card
        ...
        className={cn(
          "relative overflow-hidden group bg-black/40 backdrop-blur-xl border-white/5 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05),_0_8px_32px_0_rgba(0,0,0,0.5)] transition-all duration-300 h-full",
          className,
        )}
        {...props}
      >
