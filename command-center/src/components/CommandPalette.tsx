      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 border-b border-white/[0.06]">
          ...
          <button
            ...
            title="Close"
            className="p-1.5 text-white/25 hover:text-white/60 transition-colors flex-shrink-0 focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:outline-none rounded"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
