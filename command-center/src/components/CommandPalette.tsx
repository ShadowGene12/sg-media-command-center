      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 border-b border-white/[0.06]">
          ...
          <Command.Input
            ...
            autoFocus
          />
          <button aria-label="Close command palette" onClick={() => setCommandPaletteOpen(false)} className="p-1.5 text-white/25 hover:text-white/60 transition-colors flex-shrink-0">
            <X className="h-4 w-4" />
          </button>
        </div>
