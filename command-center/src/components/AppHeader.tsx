...
const NOTIFICATIONS = [
  {
    ...
    body: "Your Week 10 review has been prepared and is ready to view.",
    time: "2h ago",
    color: "#6D4AE6",
    unread: true,
  },
  {
    ...
    body: "SG Media added a new recommendation to your Acquisition pillar.",
    time: "1d ago",
    color: "#378ADD",
    unread: true,
  },
  {
    ...
    body: "Q3 Outbound Engine hit its first milestone checkpoint.",
    time: "2d ago",
    color: "#10B981",
    unread: false,
  },
  {
    id: 4,
    title: "Diagnostic score improved",
    body: "Your overall score moved from 12.1 to 14.2 since last run.",
    time: "3d ago",
    color: "#F59E0B",
    unread: false,
  },
      ...
      <Link to="/upgrade" className="hidden sm:block">
        <div className="animated-laser-border rounded-full p-px">
          <div className="relative z-10 bg-[#050505] rounded-full px-3 py-1 flex items-center gap-1.5 text-[10px] font-mono">
            ...
            <span className="text-violet-400 font-semibold hover:text-violet-300 transition-colors">
              Upgrade
            </span>
          </div>
        </div>
    ...
    <div className="hidden sm:flex items-center gap-2">
      ...
      >
        ...
        <Clock
          className={cn(
            "w-2.5 h-2.5",
            isExpiring ? "text-amber-400" : "text-slate-500",
          )}
        />
        <span
          className={cn(
      ...
      <header className="h-16 border-b border-white/[0.04] bg-black/20 backdrop-blur-xl flex items-center justify-between px-4 md:px-6 sticky top-0 z-40">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="relative p-2 rounded-xl text-slate-500 hover:text-white hover:bg-white/[0.04] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/50"
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                className="flex items-center justify-center w-8 h-8 rounded-full bg-violet-500/20 border border-violet-500/30 text-violet-400 hover:bg-violet-500/30 transition-all text-xs font-mono font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/50"
            ...
            <DropdownMenuContent
              align="end"
              className="w-48 bg-[#0A0A0C] border-white/[0.08] text-white"
            >
              ...
              <DropdownMenuItem
                asChild
                className="hover:bg-white/[0.04] focus:bg-white/[0.04] cursor-pointer"
              >
                <Link
                  to="/settings/account"
              ...
              <DropdownMenuItem
                ...
                className="hover:bg-white/[0.04] focus:bg-white/[0.04] cursor-pointer flex items-center gap-2 text-xs text-red-400/80 hover:text-red-400"
              >
                  ...
                  <div className="min-w-0 flex-1">
                    <p
                      className={cn(
                        ...
                        n.unread ? "text-white" : "text-slate-400",
                      )}
                    >
                      {n.title}
                    </p>
