    ...
    <>
      <header className="h-16 border-b border-white/[0.04] bg-black/20 backdrop-blur-xl flex items-center justify-between px-4 md:px-6 sticky top-0 z-40">
        ...
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="icon" aria-label="Open Mobile Menu" className="md:hidden text-slate-400 hover:text-white hover:bg-white/[0.04]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="hidden md:flex items-center gap-3 h-9 px-4 rounded-xl bg-white/[0.04] border border-white/[0.06] text-slate-500 hover:text-white hover:bg-white/[0.07] hover:border-white/[0.10] transition-all duration-200 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/50"
          >
