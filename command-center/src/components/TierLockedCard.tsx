...
export function TierLockedCard({
  ...
  // ⚡ Bolt: Using individual selectors to prevent TierLockedCard re-rendering when unrelated store properties change
      ...
      >
        ...
        >
          ...
          <p className="text-xs text-white/35 mb-5 font-sans leading-relaxed">
            ...
            {tier === "free" && trialDay > 7
              ? " Your trial ended — upgrade to regain access."
              : ""}
          </p>
